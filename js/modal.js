...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const projectData = {
        ...
        'case-auto': {
            ...
            background: 'KIPRIS(특허청 데이터베이스)의 신규 등록 데이터를 자동으로 수집하여 AI로 분석하고 콘텐츠화하여 홈페이지에 게시하는 전 과정을 완전 자동화했습니다.<br /><br />n8n과 Docker를 활용하여 데이터 파이프라인을 구축하고, 80시간 이상 소요되던 누적 업무를 1시간 30분 이내로 단축해 40배 이상의 업무 효율 향상을 달성했습니다.',
            results: [
